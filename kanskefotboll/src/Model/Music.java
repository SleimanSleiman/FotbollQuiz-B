    ...
    public class Music {
        ...
        /**
         * Spelar upp bakgrundsmusiken från den angivna filen.
         * Om musiken redan spelas, görs ingenting.
         * Ljudet spelas upp i en kontinuerligt.
         *
         * @param filename Namnet på ljudfilen som ska spelas upp.
         ...
         * När ljudet är avstängt, sparas den tidigare volymnivån och volymen sätts till minimum.
         * När ljudet sätts på igen, återställs den tidigare volymnivån.
         *
         * @author Ali Farhan
         */
