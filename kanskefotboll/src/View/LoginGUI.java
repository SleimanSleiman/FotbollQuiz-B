...
public class LoginGUI {
    ...
    /**
     * Creates a new LoginGUI.
     *
     * @param quizController The controller handling the quiz logic.
     * @uthor Manar Almaliki, Karam Kallab, Sleiman Sleiman, Ali Farhan, Elias Celayir
     */
    ...
    /**
     * Handles the behavior of the toggle button when a category is selected.
     * Unselects all other buttons and selects only the clicked button.
     *
     * @param selectedButton The selected JToggleButton.
     * @uthor Ali Farhan
     */
    private void handleToggleButton(JToggleButton selectedButton) {
        for (JToggleButton button : categoryButtons) {                if (button != selectedButton) {
